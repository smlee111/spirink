...
public final class SpWordSegmentFilter extends TokenFilter {

    private final LinkedList<KoreanToken> outQueue = new LinkedList<KoreanToken>();
    
    private boolean modeQueue = false;
    
    private SpWordSegmentAnalyzer segmentAnalyzer;
	...
	protected SpWordSegmentFilter(TokenStream input) {
		super(input);
		segmentAnalyzer = new SpWordSegmentAnalyzer();
	}

	protected SpWordSegmentFilter(TokenStream input, boolean hasOrigin) {
		this(input);
	...
	public boolean incrementToken() throws IOException {
        ...
        while (input.incrementToken()) {
        	...
        	System.out.println("(containJosa(kToken)"+containJosa(kToken));
