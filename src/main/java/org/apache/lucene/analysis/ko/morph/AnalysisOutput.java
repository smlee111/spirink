...
public class AnalysisOutput implements Cloneable {
  ...
  public static final int SCORE_TOP_CORRECT = 110;//추가
  public static final int SCORE_CORRECT = 100;//원본
  //public static final int SCORE_CORRECT = 1000;//테스트
  ...
  public static final int SCORE_ANALYSIS = 30; //원본
  //public static final int SCORE_ANALYSIS = 100; //테스트
