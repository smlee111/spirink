...
public interface PatternConstants {
  ...
  public static String getPTNStr(int PTN) {
	  String ptnstr="";
	  switch(PTN) {
	  case	PTN_N:ptnstr = "체언 : N/PN/NM/XN/CN/UN/AS/HJ/ET";
	  	break;
	  case	PTN_NJ:ptnstr = "체언 + 조사";
	  	break;
	  case	PTN_NSM:ptnstr = "체언 + 용언화접미사 + 어미";
	  	break;
	  case	PTN_NSMJ:ptnstr = "체언 + 용언화접미사 + '음/기' + 조사 ";
	  	break;
	  case	PTN_NSMXM:ptnstr = "체언 + 용언화접미사 + '아/어' + 보조용언 + 어미";
	  	break;
	  case	PTN_NJCM:ptnstr = "체언 + '에서/부터/에서부터' + '이' + 어미";
	  	break;
	  case	PTN_NSMXMJ:ptnstr = "체언 + 용언화접미사 + '아/어' + 보조용언 + '음/기' + 조사";
	  	break;
	  case	PTN_VM:ptnstr = "용언 + 어미";
	  	break;
	  case	PTN_VMJ:ptnstr = "용언 + '음/기' + 조사";
	  	break;
	  case	PTN_VMCM:ptnstr = "용언 + '음/기' + '이' + 어미 ";
	  	break;
	  case	PTN_VMXM:ptnstr = "용언 + '아/어' + 보조용언 + 어미 ";
	  	break;
	  case	PTN_VMXMJ:ptnstr = "용언 + '아/어' + 보조용언 + '음/기' + 조사";
	  	break;
	  case	PTN_AID:ptnstr = "단일어 : 부사, 관형사, 감탄사";
	  	break;
	  case	PTN_ADVJ:ptnstr = "부사 + 조사 : '빨리도' ";
	  	break;
	  case	PTN_NVM:ptnstr = "체언 + 동사 + 어미";
	  	break;
	  case	PTN_ZZZ:ptnstr = "문장부호, KS 완성형 기호열, 단독조사/어미 ";
	  	break;
	  }
	  return ptnstr;
  }
  ...
  public static char POS_NPXM  =   'N';       //* noun, pnoun, xn, nume  명사, 대명사*/
  public static char POS_VJXV  =   'V';       //* verb, adj, xverb   동사,형용사   */
  public static char POS_AID   =   'Z';       //* adv, det, excl     부사   */
  ...
  public static char POS_NOUN  =   'N';       //* noun         명사         */
  ...
  public static char POS_JOSA   =  'j';       //* Korean Josa    조사       */
  public static char POS_COPULA =  'c';       //* copula '-Wi-'         */
  public static char POS_EOMI   =  'e';       //* final Ending     어미     */
  ...
  public static char POS_SFX_V  =  't';       //* verb suffixes: '하/되' 접미사*/
