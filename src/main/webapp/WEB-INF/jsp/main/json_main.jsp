...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
   <script type="text/javaScript" language="javascript" defer="defer">
	   ...
	   function fn_work_json_insert() {
	   		document.searchForm.action = "<c:url value='/json_insert.do'/>";
	      	document.searchForm.submit();
	   }
	                ...
	                <div class="card-body">
	                  <div class="form-group row">
	                    ...
	                    <div class="form-group">
		                  <select class="form-control select2" style="width: 100%;" id="jsonPrj" name="jsonPrj">
		                      <c:choose>
			                      <c:when test="${jsonPrj eq 'hanbat'}">
			                      	<option selected="selected" value="hanbat">한밭대</option>
			                      </c:when>
			                      <c:otherwise>
			                      	<option value="hanbat">한밭대</option>
			                      </c:otherwise>
		                      </c:choose>
		                     <%--  <c:choose>
			                      <c:when test="${jsonPrj eq 'hancom'}">
			                      	<option selected="selected" value="hancom">한컴 로보틱스</option>
			                      </c:when>
			                      <c:otherwise>
			                      	<option value="hancom">한컴 로보틱스</option>
			                      </c:otherwise>
		                      </c:choose> --%>
		                  </select>
		                </div>
			            ...
			            <ol class="breadcrumb float-sm-left">
			              ...
			              <button type="button" class="btn btn-block btn-outline-primary" onClick="fn_work_json_insert()">엑셀등록</button>
