              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-hover" summary="카테고리ID, 케테고리명, 사용여부, Description, 등록자 표시하는 테이블">
        			...
        			<tr>
        				...
        				<td align="center"><spring:message code="title.sample.id" /></th>
        				<td align="center"><spring:message code="title.sample.name" /></th>
        				<td align="center"><spring:message code="title.sample.useYn" /></th>
        				<td align="center"><spring:message code="title.sample.description" /></th>
        				<td align="center"><spring:message code="title.sample.regUser" /></th>
        			</tr>
        			</thead>
        			<tbody>
