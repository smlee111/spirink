  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">작업관리</h1>
          </div><!-- /.col -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <div class="container-fluid">
			        <div class="row mb-2">
			          ...
			          <div class="col-sm-2">
			              <button type="button" class="btn btn-block btn-outline-primary" onclick="window.open(encodeURI('<c:url value='${pageContext.request.contextPath}/download/downloadFile.do?'/>requestedFile=work_templet.xlsx'))">템플릿다운로드</button>
			          </div>
			        </div>
			      </div><!-- /.container-fluid -->
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" name="insForm" id="insForm" method="post" action="${pageContext.request.contextPath}/work_insert_ok.do" enctype="multipart/form-data">
                <div class="card-body">
