   ...
   <script type="text/javaScript" language="javascript" defer="defer">
	   ...
	   function fn_work_selectList(au_mem) {
		    document.listForm.bd_idx.value=au_mem;
	   		document.listForm.action = "<c:url value='/work_relist.do'/>";
	      	document.listForm.submit();
	   }
	   function fn_work_spellList(bd_idx) {
	   		document.searchForm.action = "<c:url value='/spell_relist.do'/>";
	   		document.searchForm.bd_idx.value=bd_idx;
	      	document.searchForm.submit();
	   }
	   function fn_work_spell_search() {
	   		document.searchForm.action = "<c:url value='/spell_remain.do'/>";
	      	document.searchForm.submit();
	   }
			        ...
			        <div class="row mb-2">
			          ...
			          <div class="col-sm-6">
			            <ol class="breadcrumb float-sm-right">
			              ...
			              <a href="${pageContext.request.contextPath}/spell_reinsert.do?agent=<%=agent%>">
