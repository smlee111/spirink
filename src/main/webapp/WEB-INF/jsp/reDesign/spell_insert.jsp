...
<head>
  ...
  <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_down_excel(){
        	window.open(encodeURI('${pageContext.request.contextPath}/download/downloadFile.do?requestedFile=spell_templet.xlsx'))
        }
        function fn_submit() {
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">맞춤법작업관리</h1>
          </div><!-- /.col -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <div class="container-fluid">
			        <div class="row mb-2">
			          ...
			          <div class="col-sm-2">
			              <button type="button" class="btn btn-block btn-outline-primary" onClick="fn_down_excel()">샘플엑셀 다운로드</button>
			          </div>
			        </div>
			      </div><!-- /.container-fluid -->
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" name="insForm" id="insForm" method="post" action="${pageContext.request.contextPath}/spell_insert_ok.do" enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="button" class="btn btn-primary" onClick="fn_submit();" >저장</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
