      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
                <form:form class="form-horizontal" commandName="searchVO" id="listForm" name="listForm" method="post" action="/twitter_search.do">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="searchKeyword" class="col-sm-2 col-form-label">검색단어</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="searchKeyword" id="searchKeyword" placeholder="검색할 단어를 입력하세요." value='<c:out value="${searchKeyword}"/>'>
                ...
                <div class="card-footer">
                  ...
                  <div class="btn-group float-right">
	                  <button type="button" class="btn btn-info" onClick="fn_gen_select('2');">검색</button>
               ...
               <table id="example2" class="table table-bordered table-hover" summary="변환결과를 보는 테이블">
        			<thead>
        			<tr>
        				<td align="center">파일이름</th>
        				<td align="center">파일용량</th>
        				<td align="center">파일생성일</th>
        			</tr>
        			</thead>
        			<tbody>
        			<c:forEach var="result" items="${fileList}" varStatus="status">
            			<tr>
            				...
            				<a href="${pageContext.request.contextPath}/twitter_content.do?fName=${result.fileName}"><c:out value="${result.fileName}"/></a>
            				</td>
            				<td align="left" class="listtd"><c:out value="${result.fileSize}"/></td>
            				<td align="left" class="listtd"><c:out value="${result.fileDate}"/></td>
            			</tr>
        			</c:forEach>
        			</tbody>
        		</table>
